  ...
  <div class="min-h-screen bg-black text-white">
    ...
    <section class="px-4 py-12 text-center max-w-3xl mx-auto">
      ...
      <p class="mt-4 text-lg text-gray-300">
        Ative agora em menos de 5 minutos e volte a usar tudo sem bloqueios
      </p>
    ...
    <section class="px-4 py-12 max-w-4xl mx-auto grid gap-6 md:grid-cols-2">
      ...
      <div class="bg-white/5 p-6 rounded-xl">
        <h3 class="font-bold text-lg">💻 Funciona em tudo</h3>
        <p class="text-gray-300 mt-2">PC, Mac, Android e iOS</p>
      </div>

      <div class="bg-white/5 p-6 rounded-xl">
        <h3 class="font-bold text-lg">🔐 Seguro</h3>
        <p class="text-gray-300 mt-2">Evite bloqueios e erros de ativação</p>
      </div>
    ...
    <section class="px-4 py-12 max-w-4xl mx-auto">
      ...
      <div class="grid md:grid-cols-2 gap-6">
        <div class="bg-red-500/10 border border-red-500/20 p-6 rounded-xl">
          <h3 class="font-bold">❌ Sem ativação</h3>
          <ul class="mt-3 text-gray-300 space-y-2">
            <li>• Word bloqueado</li>
            <li>• Excel limitado</li>
            <li>• Não salva arquivos</li>
            <li>• Erros constantes</li>
          </ul>
        </div>

        <div class="bg-green-500/10 border border-green-500/20 p-6 rounded-xl">
          <h3 class="font-bold">✅ Com ativação</h3>
          <ul class="mt-3 text-gray-300 space-y-2">
            <li>• Tudo liberado</li>
            <li>• Uso completo</li>
            <li>• Sem bloqueios</li>
            <li>• Funciona normal</li>
          </ul>
        </div>
      </div>
    </section>
    ...
    <section class="px-4 py-12 max-w-4xl mx-auto grid gap-6 md:grid-cols-3">
      ...
      <div class="bg-white/5 p-6 rounded-xl">
        ...
        <p class="mt-3 text-gray-300">
          "Resolveu na hora, tava travado aqui"
        </p>
      </div>
