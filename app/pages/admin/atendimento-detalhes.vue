<template>
  <div>
    <div class="flex items-center justify-between mb-6">
      ...
      <a href="/admin/atendimentos" class="text-blue-600 hover:text-blue-800">
        Voltar
      </a>
    </div>
...
async function loadConversation() {
  ...
  try {
    ...
    console.error('[atendimento-detalhes] Error loading conversation:', err)
    error.value = true
  } finally {
    pending.value = false
  }
...
async function sendMessage() {
  ...
  try {
    ...
    console.error('[atendimento-detalhes] Error sending reply:', err)
...
async function takeover() {
  ...
  try {
    ...
    console.error('[atendimento-detalhes] Error taking over:', err)
...
async function closeConversation() {
  ...
  try {
    ...
    console.error('[atendimento-detalhes] Error closing conversation:', err)
