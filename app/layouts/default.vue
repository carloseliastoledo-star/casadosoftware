        ...
        <div class="min-h-[70px] flex items-center justify-between gap-4">
          ...
          <div class="flex items-center gap-1.5">
            <div class="hidden md:flex items-center gap-1.5">
              ...
              <div v-if="isInternational" class="flex items-center gap-1.5 h-8 rounded-md border border-gray-300 bg-white px-2">
                <span class="text-sm" aria-hidden="true">🌐</span>
                <select
                  class="bg-transparent text-xs font-semibold text-gray-700 outline-none cursor-pointer"
      ...
      <div class="max-w-7xl mx-auto px-6">
        <div class="h-20 flex items-center justify-between gap-6">
          <NuxtLink to="/" class="flex items-center gap-3 min-w-0">
            <picture>
              <source v-if="effectiveLogoWebpPath" :srcset="effectiveLogoWebpPath" type="image/webp" />
              <img :src="effectiveLogoPath" :alt="siteName" class="h-11 md:h-[64px] w-auto max-w-[150px] md:max-w-[200px] object-contain" />
            </picture>
          </NuxtLink>
      ...
      <div class="absolute inset-y-0 left-0 w-80 max-w-[92vw] bg-white shadow-2xl flex flex-col">
        <div class="px-4 py-3 border-b flex items-center justify-between">
          <NuxtLink to="/" class="flex items-center gap-2" @click="mobileMenuOpen = false">
            <picture>
              <source v-if="effectiveLogoWebpPath" :srcset="effectiveLogoWebpPath" type="image/webp" />
              <img :src="effectiveLogoPath" :alt="siteName" class="h-9 w-auto" />
            </picture>
            <span class="font-extrabold text-gray-900 truncate text-sm">{{ safeSiteName }}</span>
          </NuxtLink>
          <button
            type="button"
