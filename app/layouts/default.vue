          ...
          <div class="flex items-center gap-4 min-w-0">
            ...
            <NuxtLink to="/" class="flex items-center gap-3 min-w-0">
              <picture v-if="effectiveLogoPath">
                ...
                <img :src="effectiveLogoPath" :alt="siteName" :style="isInternational ? 'height: 160px; width: auto;' : 'height: 48px; width: auto;'" />
              </picture>
            </NuxtLink>
          </div>
      ...
      <div class="max-w-7xl mx-auto px-6">
        <div class="h-20 flex items-center justify-between gap-6">
          <NuxtLink to="/" class="flex items-center gap-3 min-w-0">
            <picture>
              <source v-if="effectiveLogoWebpPath" :srcset="effectiveLogoWebpPath" type="image/webp" />
              <img :src="effectiveLogoPath" :alt="siteName" style="height: 48px; width: auto;" />
            </picture>
          </NuxtLink>
