...
const phrasesToEn: Array<[RegExp, string]> = [
  ...
  [/login e senha para acesso ao/gi, 'login and password to access'],
  ...
  [/Nossa equipe oferece suporte em horário comercial para auxiliar no primeiro acesso, instalação e configuração da licença\./gi, 'Our team provides business hours support to assist with first access, installation, and license setup.'],
  [/Suporte e segurança/gi, 'Support and security'],
  [/Ao comprar a/gi, 'When you buy the'],
  [/você conta com:/gi, 'you get:'],
  [/Conta oficial/gi, 'Official account'],
  [/Ativação segura/gi, 'Secure activation'],
  [/Suporte para dúvidas iniciais e configuração/gi, 'Support for initial questions and setup'],
  [/Tudo para garantir uma experiência tranquila desde o primeiro acesso\./gi, 'Everything to ensure a smooth experience from the very first access.'],
  [/Informações importantes/gi, 'Important information'],
...
const phrasesToEs: Array<[RegExp, string]> = [
  ...
  [/login e senha para acesso ao/gi, 'usuario y contraseña para acceder a'],
  [/login e senha/gi, 'usuario y contraseña'],
  [/para acesso ao/gi, 'para acceder a'],
  [/O acesso é válido pelo período contratado/gi, 'El acceso es válido por el período contratado'],
  [/A ativação é rápida e simples/gi, 'La activación es rápida y sencilla'],
  [/Nossa equipe oferece suporte em horário comercial para auxiliar no primeiro acesso, instalação e configuração da licença\./gi, 'Nuestro equipo ofrece soporte en horario comercial para ayudar con el primer acceso, la instalación y la configuración de la licencia.'],
  [/Suporte e segurança/gi, 'Soporte y seguridad'],
  [/Ao comprar a/gi, 'Al comprar la'],
  [/você conta com:/gi, 'cuentas con:'],
  [/Conta oficial/gi, 'Cuenta oficial'],
  [/Ativação segura/gi, 'Activación segura'],
  [/Suporte para dúvidas iniciais e configuração/gi, 'Soporte para dudas iniciales y configuración'],
  [/Tudo para garantir uma experiência tranquila desde o primeiro acesso\./gi, 'Todo para garantizar una experiencia tranquila desde el primer acceso.'],
  [/Informações importantes/gi, 'Información importante'],
...
const phrasesToIt: Array<[RegExp, string]> = [
  ...
  [/login e senha para acesso ao/gi, 'login e password per accedere a'],
  [/login e senha/gi, 'login e password'],
  [/para acesso ao/gi, 'per accedere a'],
  [/O acesso é válido pelo período contratado/gi, 'L’accesso è valido per il periodo contrattato'],
  [/A ativação é rápida e simples/gi, 'L’attivazione è rapida e semplice'],
  [/Nossa equipe oferece suporte em horário comercial para auxiliar no primeiro acesso, instalação e configuração da licença\./gi, 'Il nostro team offre supporto negli orari di ufficio per assistere nel primo accesso, nell’installazione e nella configurazione della licenza.'],
  [/Suporte e segurança/gi, 'Supporto e sicurezza'],
  [/Ao comprar a/gi, 'Acquistando la'],
  [/você conta com:/gi, 'avrai:'],
  [/Conta oficial/gi, 'Account ufficiale'],
  [/Ativação segura/gi, 'Attivazione sicura'],
  [/Suporte para dúvidas iniciais e configuração/gi, 'Supporto per dubbi iniziali e configurazione'],
  [/Tudo para garantir uma experiência tranquila desde o primeiro acesso\./gi, 'Tutto per garantire un’esperienza tranquilla fin dal primo accesso.'],
  [/Informações importantes/gi, 'Informazioni importanti'],
...
const phrasesToFr: Array<[RegExp, string]> = [
  ...
  [/login e senha para acesso ao/gi, 'identifiant et mot de passe pour accéder à'],
  [/login e senha/gi, 'identifiant et mot de passe'],
  [/para acesso ao/gi, 'pour accéder à'],
  [/O acesso é válido pelo período contratado/gi, 'L’accès est valable pour la période contractée'],
  [/A ativação é rápida e simples/gi, 'L’activation est rapide et simple'],
  [/Nossa equipe oferece suporte em horário comercial para auxiliar no primeiro acesso, instalação e configuração da licença\./gi, 'Notre équipe offre un support pendant les heures ouvrées pour aider au premier accès, à l’installation et à la configuration de la licence.'],
  [/Suporte e segurança/gi, 'Support et sécurité'],
  [/Ao comprar a/gi, 'En achetant la'],
  [/você conta com:/gi, 'vous bénéficiez de :'],
  [/Conta oficial/gi, 'Compte officiel'],
  [/Ativação segura/gi, 'Activation sécurisée'],
  [/Suporte para dúvidas iniciais e configuração/gi, 'Support pour les questions initiales et la configuration'],
  [/Tudo para garantir uma experiência tranquila desde o primeiro acesso\./gi, 'Tout pour garantir une expérience sereine dès le premier accès.'],
  [/Informações importantes/gi, 'Informations importantes'],
