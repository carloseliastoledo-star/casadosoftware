...
const commonToEn: Array<[RegExp, string]> = [
  ...
  [/\bguia\b/gi, 'guide'],
  [/\bGuia\b/gi, 'Guide'],
  [/\bpasso a passo\b/gi, 'step by step'],
  [/\bPasso a Passo\b/gi, 'Step by Step'],
  [/\bcompleto\b/gi, 'complete'],
  [/\bCompleto\b/gi, 'Complete'],
  [/\bNovamente\b/gi, 'Again'],
  [/\bnovamente\b/gi, 'again'],
  [/\bfunciona\b/gi, 'works'],
  [/\bFunciona\b/gi, 'Works'],
  [/\bconfiável\b/gi, 'reliable'],
  [/\bConfiável\b/gi, 'Reliable'],
  [/\bativado\b/gi, 'activated'],
  [/\bAtivado\b/gi, 'Activated'],
  [/\bpedindo\b/gi, 'asking for'],
  [/\bPedindo\b/gi, 'Asking for']
]
...
const phrasesToEn: Array<[RegExp, string]> = [
  ...
  [/Entrega imediata após confirmação/gi, 'Fast delivery after confirmation'],
  [/Entrega rápida após confirmação/gi, 'Fast delivery after confirmation'],
  [/Envio imediato após confirmação/gi, 'Fast delivery after confirmation'],
  [/Envio rápido após confirmação/gi, 'Fast delivery after confirmation'],
  [/Licença digital com ativação permanente/gi, 'Digital license with permanent activation'],
  [/Licença digital permanente/gi, 'Permanent digital license'],
  [/Suporte em horário comercial/gi, 'Business hours support'],
  [/Suporte 24\/7/gi, '24/7 support'],
  [/Compatível Windows 10 e 11/gi, 'Compatible with Windows 10 and 11'],
  [/Ativação permanente/gi, 'Permanent activation'],
  [/Sem renovação necessária/gi, 'No renewal required'],
  [/Sem renovação/gi, 'No renewal required'],
  [/Versão profissional com recursos avançados/gi, 'Professional version with advanced features'],
  [/Acesso digital com conta ativa/gi, 'Digital access with active account'],
  [/Uso durante o período contratado/gi, 'Use during contracted period'],
  [/Uso contínuo sem mensalidade/gi, 'Continuous use, no monthly fee'],
  [/5 PC , MAC , IOS , Tablet e Celular/gi, '5 PCs, Mac, iOS, Tablet and Mobile'],
  [/5 PC , MAC , iOS , Tablet e Celular/gi, '5 PCs, Mac, iOS, Tablet and Mobile'],
  [/5 PC, MAC , IOS , Tablet e Celular/gi, '5 PCs, Mac, iOS, Tablet and Mobile'],
  [/5 PC, MAC , iOS , Tablet e Celular/gi, '5 PCs, Mac, iOS, Tablet and Mobile'],
  [/5 PC, MAC, iOS, Tablet e Celular/gi, '5 PCs, Mac, iOS, Tablet and Mobile'],
  [/5 PC, MAC, IOS, Tablet e Celular/gi, '5 PCs, Mac, iOS, Tablet and Mobile'],
  [/Atualizações gratuitas/gi, 'Free updates'],
  [/Atualização gratuita/gi, 'Free updates'],
  [/Sem mensalidade/gi, 'No monthly fee'],
  [/Uso vitalício/gi, 'Lifetime use'],
  [/Chave ESD/gi, 'ESD Key'],
  [/Instalação simples/gi, 'Easy installation']
]
