  ...
  try {
    const updated = await (prisma as any).produto.update({
      ...
      data: {
        ...
        ...(typeof body.seoTitle === 'string' ? { seoTitle: body.seoTitle.trim() || null } : {}),
        ...(typeof body.seoDescription === 'string' ? { seoDescription: body.seoDescription.trim() || null } : {}),
        ...(typeof body.seoContent === 'string' ? { seoContent: body.seoContent.trim() || null } : {}),
        ...(typeof body.imageAlt === 'string' ? { imageAlt: body.imageAlt.trim() || null } : {}),
        ...(typeof body.imageTitle === 'string' ? { imageTitle: body.imageTitle.trim() || null } : {}),
